...
All arrays were opened with `allow_pickle=False` during preparation. The model files were inspected as HDF5 metadata without executing or training the models. Inference, architecture compatibility, and numerical agreement with the original results were not validated.
